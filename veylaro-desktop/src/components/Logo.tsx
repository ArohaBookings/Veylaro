...
/** The Veylaro mark — twin V blades (ink + copper) with the star. */
  ...
  return (
    ...
    >
      <defs>
        ...
        <linearGradient id={`star-${id}`} x1="120" y1="14" x2="120" y2="64" gradientUnits="userSpaceOnUse">
      ...
      <path className="blade-l" d="M 94 62 L 64 62 Q 52 62 55 74 L 106 184 Q 112 196 117 185 Q 106 122 94 62 Z" fill={ink} />
      <path className="blade-r" d="M 146 62 L 176 62 Q 188 62 185 74 L 137 172 Q 131 184 126 173 Q 137 118 146 62 Z" fill={`url(#cop-${id})`} />
      <path
        className="star"
